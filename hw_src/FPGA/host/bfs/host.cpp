...
/** Create Kernels */
//OCL_CHECK(err, cl::Kernel kernel(program,"bfs_kernel_0", &err));
std::vector<cl::Kernel> krnls(num_cu);
//	OCL_CHECK(err, krnls[i] = cl::Kernel(program, "bfs_kernel_0", &err));

krnls[0] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_1}", &err);
krnls[1] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_2}", &err);
krnls[2] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_3}", &err);
krnls[3] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_4}", &err);
krnls[4] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_5}", &err);
krnls[5] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_6}", &err);
krnls[6] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_7}", &err);
krnls[7] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_8}", &err);
krnls[8] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_9}", &err);
krnls[9] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_10}", &err);
krnls[10] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_11}", &err);
krnls[11] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_12}", &err);
krnls[12] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_13}", &err);
krnls[13] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_14}", &err);
krnls[14] = cl::Kernel(program, "bfs_kernel_0:{bfs_kernel_0_15}", &err);
