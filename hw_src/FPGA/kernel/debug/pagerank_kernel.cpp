...
#pragma HLS ARRAY_PARTITION variable=prev_buffer /*cyclic factor=16*/ dim=0
	u32 rank_buffer[BUF_PER_PE]; // Local Memory to store result
#pragma HLS ARRAY_PARTITION variable=rank_buffer /*cyclic factor=16 */ dim=0
