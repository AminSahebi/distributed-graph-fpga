...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename e_src_buffer_a \
    op interface \
    ports { e_src_buffer_a_address0 { O 12 vector } e_src_buffer_a_ce0 { O 1 bit } e_src_buffer_a_we0 { O 1 bit } e_src_buffer_a_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'e_src_buffer_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename e_dst_buffer_a \
    op interface \
    ports { e_dst_buffer_a_address0 { O 12 vector } e_dst_buffer_a_ce0 { O 1 bit } e_dst_buffer_a_we0 { O 1 bit } e_dst_buffer_a_d0 { O 5 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'e_dst_buffer_a'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 3 \
    name out_deg_buffer_a \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename out_deg_buffer_a \
    op interface \
    ports { out_deg_buffer_a_address0 { O 12 vector } out_deg_buffer_a_ce0 { O 1 bit } out_deg_buffer_a_we0 { O 1 bit } out_deg_buffer_a_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'out_deg_buffer_a'"
}
}
